      ...
      <div className='contact-body'>
        <h1 className="heading" data-aos="zoom-out">Meet the <span className="span text-transparent bg-clip-text ">Team</span> </h1>
          <div className='contact-container' data-aos="fade-in" data-aos-delay="1000">
            ...
            <Card name="Tanishq Agarwal" title="Back-End Developer" image="https://media.licdn.com/dms/image/D4D03AQErSFQvvNkzmA/profile-displayphoto-shrink_800_800/0/1691864426120?e=1701302400&v=beta&t=lnPeW4M6mbORNwgcYZXLW1ABT9y6oaklbUCmaKhPmxc" />
          ...
          <div className='contact-container' data-aos="fade-in" data-aos-delay="2000">
              <Card name="Satyam Singh" title="Web Developer" image="https://media.licdn.com/dms/image/D4D03AQHjyLJxN6LLZw/profile-displayphoto-shrink_800_800/0/1686240990025?e=1701302400&v=beta&t=sTTrISVOArn3QGzr_SwURpInpKOvMOTQcLgv7LqrSxk"/>
